package gutierrez.leal.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import android.widget.Toast
import gutierrez.leal.myfeelings.utilities.CustomBarDrawable
import gutierrez.leal.myfeelings.utilities.CustomCircleDrawable
import gutierrez.leal.myfeelings.utilities.Emociones
import gutierrez.leal.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if(verySad>happy && verySad>neutral && verySad>sad && veryHappy<verySad){
            icon.setImageDrawable(resources.getDrawable(R.drawable.ic_baseline_mood_bad_24))
        }
